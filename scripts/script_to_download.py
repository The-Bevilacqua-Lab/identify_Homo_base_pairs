...
df_str= pd.read_csv('/storage/work/mks7008/NMR_structures/All_NMR_Structures.csv')
home= os.getcwd()
str_files=[]
str_dir= '/storage/work/mks7008/NMR_structures' #directory where we want to save the structures
os.chdir(str_dir)
